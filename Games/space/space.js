...
let level = 0;
let PNG = "./assets/spaceship"+level+".png";
let ALI = "./assets/invader"+level+".png";
const MAXLVL = 2;
const MAXHLTH = 2;
...
function updateAssets(){
    PNG = "./assets/spaceship"+level+".png";
    ALI = "./assets/invader"+level+".png";
}
        ...
        bonus.push(new Bonus(
            {
                ...
                url: './assets/'+types[chosenType].type+'.png'
            }));
    }
...
function applyShieldBonus(){
    ...
    spaceshipProtect.src = './assets/spaceshipProtect.png';
    ...
    invaderProjectiles.forEach( (invaderProjectile, invaderProjectileIndex) =>{
        ...
        if (invaderProjectile_player_hitbox(invaderProjectile)){
            ...
            if (player.health === 0){
                ...
                player.health -= 1;
                player.image.src = "./assets/spaceshipDamage.png";
                count = 0;
            }
        }
    });
