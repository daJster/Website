...
let audio1 = new Audio('./audio/ost.mp3');
...
function sound(){
    if (document.getElementsByClassName("sound")[0].getAttribute("sound") === "off"){
        ...
        document.getElementsByClassName("sound")[0].style.backgroundImage = "url('../../images/logos/sound-icon.jpg')";
        playedAudio.play();
    } else{
        document.getElementsByClassName("sound")[0].setAttribute("sound", "off");
        document.getElementsByClassName("sound")[0].style.backgroundImage = "url('../../images/logos/no-sound-icon.jpg')";
        playedAudio.pause();
    }
}
